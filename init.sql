...
CREATE TABLE IF NOT EXISTS user_settings (
    ...
    onboarding_completion_acknowledged BIT(1) NOT NULL DEFAULT b'0',
    onboarding_completed BIT(1) NOT NULL DEFAULT b'0',
    onboarding_dismissed BIT(1) NOT NULL DEFAULT b'0',
    onboarding_has_created_diary BIT(1) NOT NULL DEFAULT b'0',
    onboarding_has_created_schedule BIT(1) NOT NULL DEFAULT b'0',
    onboarding_has_viewed_analysis BIT(1) NOT NULL DEFAULT b'0',
